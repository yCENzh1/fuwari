...
description: "开源万岁~0721~"
tags: [IDEA, Plugin, MC, Building]
category: "MC高版本腐竹教程"
draft: false
---

> 挨多☆米那桑(◦˙▽˙◦)，今天是柚子社♡大贤☆宗☆师「绫地宁宁」的纪念日07.21喵(\(\ast\)❛ั∀❛ั\(\ast\))✧\*。将这条消息转发到十个群（笑），将会在「图书馆」遇到一位正在打☆磨桌角的宁宁的说(=^▽^=)♡，我试过了，是假的喵(。・\`ω´・)，还会被骂柚♪子♪厨退群，苦亚西(◦\`~\´◦)，得磨，今天真的是绫地宁宁的纪念日07.21……（\`Δ´）ゞ，让我们一起为宁宁庆祝喵！Ciallo～(∠・ω< )⌒☆
